...
from mainapp.models import ShowUser, User, CreateUpdateUser, Login
from mainapp.routers.auth import AuthHandler
...
def protected(username=Depends(auth_handler.auth_wrapper)):
    return {'name': f'Aferim {username} sonunda becerdin.'}
